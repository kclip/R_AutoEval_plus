...
def get_hard_decision_from_prompts(prompts, eval_template, eval_data, demos_template, few_shot_data, eval_method, config):
    """
    Returns the scores for a list of prompts.
    Parameters:
        prompts: A list of prompts.
    ...
    Returns:
        An evaluation result object.
    """
    return get_hard_prediction(prompts, eval_template, eval_data, demos_template, few_shot_data, config)
